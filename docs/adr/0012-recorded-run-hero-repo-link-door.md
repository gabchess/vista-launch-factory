...
installable Augment pack follows as the handoff artifact, distributed as a **repo link**
(not a ZIP as primary): any host agent (Claude Code, ChatGPT, Codex, Cursor, Hermes)
receives the URL plus "install this Augment" and self-installs from README + START-HERE.
...
shows a stranger can keep it. Supersedes the old lock where the Augment was the hero and
