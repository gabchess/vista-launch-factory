...
six outputs + campaign cadence out, Reviewer gates visible, nothing auto-published. The
...
the client brief says "show the recorded video of the run." The brief also says the
