...
Barry remains the actual human for Vista delivery. Gabe is the actual human for his own validation work. Specialists draft and recommend; they cannot assume either identity. Review subjects bind the artifact's version/hash and relevant transitive inputs. The helper compares evidence and never persists, authenticates or applies approvals. Legacy release-record/transition helpers retain their structural limits and receive no manufactured Barry event from this layer.
