...
Claude ZIP is present (`claude/launch-factory-v0.2.0.zip`) with Codex skill door. Fresh-host activation remains unverified — see HOST-MATRIX. Folder/ZIP visible ≠ Augment active. Claude ZIP must not fork a second schema tree; canonical schemas stay under `engine/`.
