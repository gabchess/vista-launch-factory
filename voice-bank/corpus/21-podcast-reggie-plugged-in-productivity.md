...
> And fundamentally, I always felt like context switching is not a problem. You need to be able to switch between what you're doing and the slack and then an email and an instant notice based on shifting priorities that are calling for your attention. But what I didn't realize is how much less I can actually get done by having to do that because nothing I'm starting a lot of things, but not really finishing anything. So, by the end of the day, I feel so unproductive when that's all I've been dealing with. Having my attention be pulled reactively into different areas.

On the 4 AM myth:

> I don't believe that waking up earlier has any impact in your ability to produce things. It has to do with are you able to get focused and stay focused during your day? Create the discipline and the environment where you've got your do not disturbs or whatever it is. You blocked time out. You carved time out and that's your sole focus. Um and waking up early has nothing to do with it.
