...
**Collector:** Hermes agent on behalf of Gabe, for the Vista Launch Factory project.
...
- **Read-only discipline:** the vista-launch-factory repo was not modified; only the one fixture file was read. All work lives in `/Users/gava/projects/vlf/voice-bank-staging/`.
...
| website | 12 | 02–11, 23, 24 |
| social (X + podcast transcript + Instagram snippet) | 8 | 12–16, 21, 22, 25 |
| linkedin | 4 | 17–20 |

Voice attribution: 20 items company-voiced (Vista Social), 5 items Reggie-voiced (11, 20, 21, 22, 25 — labeled in each file's notes), 1 Barry-voiced seed (01). Item 25 is dual-purpose (Reggie personal social). Podcast items 21–22 are Reggie spoken; the podcast host is Barry (Plugable).
