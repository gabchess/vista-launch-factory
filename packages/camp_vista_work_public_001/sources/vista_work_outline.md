...
- Open the task and the post is right there: the actual content, not a card describing it.
...
- Six outputs named in brief; video/login/popup held when no real footage (ADR 0001).

## Forbidden seeds
- Invented pricing, seat math, or plan $ amounts.
- Invented Vista Work capabilities beyond linked task↔post in Barry email.
- Auto-publish / Barry zero-edit.
- Treating Demo Assets as Claim Ledger evidence.
